        ...
        public void OnReceive(IAsyncResult result)
        {
            ...
            if (buffer.Length > 0)
            {
                try
                {
                    ...
                    Console.WriteLine("[Handle]<pid>" + pid);
                ...
                catch (Exception e)
                {
                    ...
                    BlockAddress(point.Address.ToString(), 5);
                }
            }
        }
            ...
            if (packet.Length > 0)
            {
                ...
                if (id == RakNet.PACKET_ENCAPSULATED)
                {
                    ...
                    if (sessions.ContainsKey(identifier))
                    {
                        ...
                        //sessions[identifier].addEncapsulatedToQueue(EncapsulatedPacket::fromBinary(buffer, true), flags);
                    }
                    else
                    {
