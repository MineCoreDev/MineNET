...
namespace MineNET.Network
{
    public sealed class NetworkManager : IDisposable
    {
        ...
        public ConcurrentDictionary<string, NetworkSession> Sessions { get; } =
            new ConcurrentDictionary<string, NetworkSession>();
        ...
        private void RegisterRakNetPackets()
        {
            ...
            MineNET_Registries.RakNetPacket.Add(RakNetProtocol.ServerHandShakeDataPacket,
                new ServerHandShakeDataPacket());
            MineNET_Registries.RakNetPacket.Add(RakNetProtocol.ClientHandShakeDataPacket,
                new ClientHandShakeDataPacket());

            MineNET_Registries.RakNetPacket.Add(RakNetProtocol.ClientDisconnectDataPacket,
                new ClientDisconnectDataPacket());
        ...
        private void RegisterMinecraftPackets()
        {
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SERVER_TO_CLIENT_HANDSHAKE_PACKET,
                new ServerToClientHandshakePacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.CLIENT_TO_SERVER_HANDSHAKE_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.RESOURCE_PACKS_INFO_PACKET,
                new ResourcePacksInfoPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.RESOURCE_PACK_STACK_PACKET,
                new ResourcePackStackPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.RESOURCE_PACK_CLIENT_RESPONSE_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.ADD_HANGING_ENTITY_PACKET,
                new AddHangingEntityPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.TAKE_ITEM_ENTITY_PACKET,
                new TakeItemEntityPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.MOVE_ENTITY_ABSOLUTE_PACKET,
                new MoveEntityAbsolutePacket());
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.LEVEL_SOUND_EVENT_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.UPDATE_ATTRIBUTES_PACKET,
                new UpdateAttributesPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.INVENTORY_TRANSACTION_PACKET,
                new InventoryTransactionPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.MOB_EQUIPMENT_PACKET, new MobEquipmentPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.MOB_ARMOR_EQUIPMENT_PACKET,
                new MobArmorEquipmentPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.INTERACT_PACKET, new InteractPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.BLOCK_PICK_REQUEST_PACKET,
                new BlockPickRequestPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.ENTITY_PICK_REQUEST_PACKET,
                new EntityPickRequestPacket());
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_ENTITY_MOTION_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_SPAWN_POSITION_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.CONTAINER_CLOSE_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.INVENTORY_CONTENT_PACKET,
                new InventoryContentPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.INVENTORY_SLOT_PACKET, new InventorySlotPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.CONTAINER_SET_DATA_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.GUI_DATA_PICK_ITEM_PACKET,
                new GuiDataPickItemPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.ADVENTURE_SETTINGS_PACKET,
                new AdventureSettingsPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.BLOCK_ENTITY_DATA_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_COMMANDS_ENABLED_PACKET,
                new SetCommandsEnabledPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_DIFFICULTY_PACKET, new SetDifficultyPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.CHANGE_DIMENSION_PACKET,
                new ChangeDimensionPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_PLAYER_GAME_TYPE_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SPAWN_EXPERIENCE_ORB_PACKET,
                new SpawnExperienceOrbPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.CLIENTBOUND_MAP_ITEM_DATA_PACKET,
                new ClientboundMapItemDataPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.MAP_INFO_REQUEST_PACKET,
                new MapInfoRequestPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.REQUEST_CHUNK_RADIUS_PACKET,
                new RequestChunkRadiusPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.CHUNK_RADIUS_UPDATED_PACKET,
                new ChunkRadiusUpdatedPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.ITEM_FRAME_DROP_ITEM_PACKET,
                new ItemFrameDropItemPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.GAME_RULES_CHANGED_PACKET,
                new GameRulesChangedPacket());
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.AVAILABLE_COMMANDS_PACKET,
                new AvailableCommandsPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.COMMAND_REQUEST_PACKET,
                new CommandRequestPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.COMMAND_BLOCK_UPDATE_PACKET,
                new CommandBlockUpdatePacket());
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.RESOURCE_PACK_DATA_INFO_PACKET,
                new ResourcePackDataInfoPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.RESOURCE_PACK_CHUNK_DATA_PACKET,
                new ResourcePackChunkDataPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.RESOURCE_PACK_CHUNK_REQUEST_PACKET,
                new ResourcePackChunkRequestPacket());
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.ADD_BEHAVIOR_TREE_PACKET,
                new AddBehaviorTreePacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.STRUCTURE_BLOCK_UPDATE_PACKET,
                new StructureBlockUpdatePacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SHOW_STORE_OFFER_PACKET,
                new ShowStoreOfferPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.PURCHASE_RECEIPT_PACKET,
                new PurchaseReceiptPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.PLAYER_SKIN_PACKET, new PlayerSkinPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SUB_CLIENT_LOGIN_PACKET,
                new SubClientLoginPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.W_S_CONNECT_PACKET, new WSConnectPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_LAST_HURT_BY_PACKET,
                new SetLastHurtByPacket());
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.MODAL_FORM_REQUEST_PACKET,
                new ModalFormRequestPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.MODAL_FORM_RESPONSE_PACKET,
                new ModalFormResponsePacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SERVER_SETTINGS_REQUEST_PACKET,
                new ServerSettingsRequestPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SERVER_SETTINGS_RESPONSE_PACKET,
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_DEFAULT_GAME_TYPE_PACKET,
                new SetDefaultGameTypePacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.REMOVE_OBJECTIVE_PACKET,
                new RemoveObjectivePacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_DISPLAY_OBJECTIVE_PACKET,
                new SetDisplayObjectivePacket());
            ...
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.UPDATE_BLOCK_SYNCED_PACKET,
                new UpdateBlockSyncedPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.MOVE_ENTITY_DELTA_PACKET,
                new MoveEntityDeltaPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_SCOREBOARD_IDENTITY_PACKET,
                new SetScoreboardIdentityPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.SET_LOCAL_PLAYER_AS_INITIALIZED_PACKET,
                new SetLocalPlayerAsInitializedPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.UPDATE_SOFT_ENUM_PACKET,
                new UpdateSoftEnumPacket());
            MineNET_Registries.MinecraftPacket.Add(MinecraftProtocol.NETWORK_STACK_LATENCY_PACKET,
                new NetworkStackLatencyPacket());
        }
        ...
        public void SessionCreate(IPEndPoint endPoint, long clientID, short mtuSize)
        {
            if (!this.SessionCreated(endPoint))
            {
                CreateSessionEventArgs ev =
                    new CreateSessionEventArgs(endPoint, new NetworkSession(endPoint, clientID, mtuSize));
