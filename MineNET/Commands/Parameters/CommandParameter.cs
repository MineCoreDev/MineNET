...
namespace MineNET.Commands.Parameters
{
    public class CommandParameter
    {
        ...
        public const int ARG_TYPE_WILDCARD_TARGET = 0x0a;

        public const int ARG_TYPE_UNKNOWN = 0x0e;

        public const int ARG_TYPE_STRING = 0x1a;

        public const int ARG_TYPE_POSITION = 0x1c;

        public const int ARG_TYPE_MESSAGE = 0x1f;
        public const int ARG_TYPE_TEXT = 0x21;

        public const int ARG_TYPE_JSON = 0x24;

        public const int ARG_TYPE_COMMAND = 0x2b;
